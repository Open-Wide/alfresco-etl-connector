...
/**
 * Tests the ACP XML writer using "mapped" methods.
...
public class RestClientAcpXmlWriterImportTest extends TestCase {
   ...
   public RestClientAcpXmlWriterImportTest() {
      super(RestClientAcpXmlWriterImportTest.class.getName());
   }
   ...
   public void testWriterImport() throws RestClientException {
      ...
      try {
         ...
         acpXmlWriter.writeMappedAspects(new ArrayList<Map<String, String>>() { {
            add(new HashMap<String, String>() { {
